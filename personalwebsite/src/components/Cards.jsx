...
export function Largecard({ img, title, description }) {
    return (
        <button className="min-w-[55%] max-w-full gap-5 mb-5 flex-col place-self-center h-[400px] min-h-[20%] cursor-pointer hover:bg-[#f3f5fd] border-1 border-gray-100 rounded-md">
            <img className="h-[65%] w-[100%] border-1 border-gray-100 rounded-md" src={`${img}`} />
