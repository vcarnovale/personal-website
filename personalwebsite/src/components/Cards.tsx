...
export function Smallcard({ img, title, subtitle, description, optional }:SmallCardProps) {
    ...
    return (
        <button className="max-w-max min-w-full grid grid-rows-1 grid-cols-[120px_1fr] auto-rows-auto auto-cols-auto gap-5 h-[10%] min-h-[10%] cursor-pointer hover:bg-[#f3f5fd] border-1 border-gray-100">
